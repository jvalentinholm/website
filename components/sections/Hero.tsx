...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-offWhite soft-grid">
      ...
      <div className="cx-container relative grid min-h-[calc(100vh-112px)] gap-16 pb-20 pt-10 md:pb-24 md:pt-14 lg:grid-cols-[1.04fr_.96fr] lg:items-center lg:gap-20 lg:pb-28">
        ...
        <div className="max-w-5xl pt-12 md:pt-16 lg:pt-0">
          <p className="mb-7 max-w-fit rounded-full bg-white/72 px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.30em] text-coreGreen ring-1 ring-coreGreen/10">
            Industrial platform for chemical recycling
          </p>
          ...
          <p className="mt-8 max-w-2xl text-xl leading-9 text-black/68 md:text-2xl md:leading-10">
            We help organisations transform difficult plastic waste into certified circular feedstock for the production of new plastics.
          </p>

          <div className="mt-10 flex flex-wrap gap-4">
            <Button href="#feedstock">Can we recycle your plastic? <span className="ml-2">→</span></Button>
            <Button href="#platform" variant="secondary">How it works</Button>
          </div>

          <p className="mt-8 max-w-xl text-sm leading-7 text-black/54">
            For municipalities, waste companies, sorting facilities, industrial companies and brands looking for a documented alternative to incineration and landfill.
          </p>
        </div>
